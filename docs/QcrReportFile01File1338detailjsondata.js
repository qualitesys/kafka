...
{ "ligne" : {
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00042] In method org.apache.kafka.image.LocalReplicaChanges.toString@POLYN166189 the MagicNumber/String  'LocalReplicaChanges(deletes = %s, leaders = %s, followers = %s)' should be converted to const"
}} 
,
{ "ligne" : {
   "c1" : "00049"
...
{ "ligne" : {
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00060] In method org.apache.kafka.image.LocalReplicaChanges.PartitionInfo.toString@POLYN166741 the MagicNumber/String  'PartitionInfo(topicId = %s, partition = %s)' should be converted to const"
}} 
]
};
