...
{ "ligne" : {
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00025] In method org.apache.kafka.connect.runtime.WorkerTransactionContext.commitTransaction@POLYN169601 the MagicNumber/String  true should be converted to const"
}} 
,
{ "ligne" : {
   "c1" : "00029"
...
{ "ligne" : {
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00030] In method org.apache.kafka.connect.runtime.WorkerTransactionContext.commitTransaction@POLYN169717 the MagicNumber/String  'Source record used to define transaction boundaries may not be null' should be converted to const"
}} 
,
{ "ligne" : {
   "c1" : "00035"
...
{ "ligne" : {
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00036] In method org.apache.kafka.connect.runtime.WorkerTransactionContext.abortTransaction@POLYN169965 the MagicNumber/String  true should be converted to const"
}} 
,
{ "ligne" : {
   "c1" : "00040"
...
{ "ligne" : {
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00041] In method org.apache.kafka.connect.runtime.WorkerTransactionContext.abortTransaction@POLYN170081 the MagicNumber/String  'Source record used to define transaction boundaries may not be null' should be converted to const"
}} 
,
{ "ligne" : {
   "c1" : "00045"
...
{ "ligne" : {
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00048] In method org.apache.kafka.connect.runtime.WorkerTransactionContext.shouldCommitBatch@POLYN170323 the MagicNumber/String  false should be converted to const"
}} 
,
{ "ligne" : {
   "c1" : "00052"
...
{ "ligne" : {
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00055] In method org.apache.kafka.connect.runtime.WorkerTransactionContext.shouldAbortBatch@POLYN170569 the MagicNumber/String  false should be converted to const"
}} 
,
{ "ligne" : {
   "c1" : "00059"
...
{ "ligne" : {
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00076] In method org.apache.kafka.connect.runtime.WorkerTransactionContext.checkBatchRequestsConsistency@POLYN171232 the MagicNumber/String  'Connector requested both commit and abort of same transaction' should be converted to const"
}} 
,
{ "ligne" : {
   "c1" : "00080"
...
{ "ligne" : {
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00082] In method org.apache.kafka.connect.runtime.WorkerTransactionContext.checkRecordRequestConsistency@POLYN171420 the MagicNumber/String  'Connector will fail as it has requested both commit and abort of transaction for same record: {}' should be converted to const"
}} 
,
{ "ligne" : {
   "c1" : "00084"
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00084] In method org.apache.kafka.connect.runtime.WorkerTransactionContext.checkRecordRequestConsistency@POLYN171420 the MagicNumber/String  'Connector requested both commit and abort of same record against topic/partition %s/%s' should be converted to const"
}} 
,
{ "ligne" : {
   "c1" : "00001"
 ...
 , "c2" : "CRITICAL"
 , "c3" : "QC-JAV999994[00001] Recursive call with depth 1 for org.apache.kafka.connect.runtime.WorkerTransactionContext.checkRecordRequestConsistency@POLYN171420"
}} 
,
{ "ligne" : {
   "c1" : "00082"
 , "c1link" : "./qc/connect/runtime/src/main/java/org/apache/kafka/connect/runtime/WorkerTransactionContext.java.html#82"
 , "c2" : "BLOCKER"
 , "c3" : "QC-JAV999993[00082] In the recursive method org.apache.kafka.connect.runtime.WorkerTransactionContext.checkRecordRequestConsistency@POLYN171420 the MagicNumber/String 'Connector will fail as it has requested both commit and abort of transaction for same record: {}' MUST BE CONVERTED to const"
}} 
,
{ "ligne" : {
   "c1" : "00084"
 , "c1link" : "./qc/connect/runtime/src/main/java/org/apache/kafka/connect/runtime/WorkerTransactionContext.java.html#84"
 , "c2" : "BLOCKER"
 , "c3" : "QC-JAV999993[00084] In the recursive method org.apache.kafka.connect.runtime.WorkerTransactionContext.checkRecordRequestConsistency@POLYN171420 the MagicNumber/String 'Connector requested both commit and abort of same record against topic/partition %s/%s' MUST BE CONVERTED to const"
}} 
]
};
