...
"data00" : {
 ...
 , "texte" : "File connect/runtime/src/main/java/org/apache/kafka/connect/runtime/rest/errors/ConnectExceptionMapper.java 4 rule violations " 
 , "fic3"  : "" 
}
, 
"data01" : [
...
{ "ligne" : {"" : ""
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00039] In method org.apache.kafka.connect.runtime.rest.errors.ConnectExceptionMapper.toResponse@POLYN153256 the MagicNumber/String  'Uncaught exception in REST call to /{}' should be converted to const"
}} 
,
{ "ligne" : {"" : ""
 , "c1" : "00061"
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00061] In method org.apache.kafka.connect.runtime.rest.errors.ConnectExceptionMapper.toResponse@POLYN153256 the MagicNumber/String  'Uncaught exception in REST call to /{}' should be converted to const"
}} 
]
, 
"data15" : {
