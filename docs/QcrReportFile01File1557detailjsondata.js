...
{ "ligne" : {"" : ""
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00064] In method org.apache.kafka.server.log.remote.metadata.storage.ConsumerManager.ConsumerManager@POLYN172624 the MagicNumber/String  60_000L should be converted to const"
}} 
,
{ "ligne" : {"" : ""
 , "c1" : "00065"
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00065] In method org.apache.kafka.server.log.remote.metadata.storage.ConsumerManager.ConsumerManager@POLYN172624 the MagicNumber/String  'RLMMConsumerTask' should be converted to const"
}} 
,
{ "ligne" : {"" : ""
 , "c1" : "00072"
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00072] In method org.apache.kafka.server.log.remote.metadata.storage.ConsumerManager.startConsumerThread@POLYN173542 the MagicNumber/String  'RLMM Consumer task thread is started' should be converted to const"
}} 
,
{ "ligne" : {"" : ""
 , "c1" : "00074"
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00074] In method org.apache.kafka.server.log.remote.metadata.storage.ConsumerManager.startConsumerThread@POLYN173542 the MagicNumber/String  'Error encountered while initializing and scheduling ConsumerTask thread' should be converted to const"
}} 
,
{ "ligne" : {"" : ""
 , "c1" : "00085"
...
{ "ligne" : {"" : ""
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00103] In method org.apache.kafka.server.log.remote.metadata.storage.ConsumerManager.waitTillConsumptionCatchesUp@POLYN174478 the MagicNumber/String  'This consumer is not subscribed to the target partition ' should be converted to const"
}} 
,
{ "ligne" : {"" : ""
 , "c1" : "00103"
 , "c1link" : "./qc/storage/src/main/java/org/apache/kafka/server/log/remote/metadata/storage/ConsumerManager.java.html#103"
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00103] In method org.apache.kafka.server.log.remote.metadata.storage.ConsumerManager.waitTillConsumptionCatchesUp@POLYN174478 the MagicNumber/String  ' on which message is produced.' should be converted to const"
}} 
,
{ "ligne" : {"" : ""
 , "c1" : "00108"
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00108] In method org.apache.kafka.server.log.remote.metadata.storage.ConsumerManager.waitTillConsumptionCatchesUp@POLYN174478 the MagicNumber/String  true should be converted to const"
}} 
,
{ "ligne" : {"" : ""
 , "c1" : "00109"
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00109] In method org.apache.kafka.server.log.remote.metadata.storage.ConsumerManager.waitTillConsumptionCatchesUp@POLYN174478 the MagicNumber/String  1L should be converted to const"
}} 
,
{ "ligne" : {"" : ""
 , "c1" : "00114"
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00114] In method org.apache.kafka.server.log.remote.metadata.storage.ConsumerManager.waitTillConsumptionCatchesUp@POLYN174478 the MagicNumber/String  'Committed offset [{}] for partition [{}], but the target offset: [{}],  Sleeping for [{}] to retry again' should be converted to const"
}} 
,
{ "ligne" : {"" : ""
 , "c1" : "00118"
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00118] In method org.apache.kafka.server.log.remote.metadata.storage.ConsumerManager.waitTillConsumptionCatchesUp@POLYN174478 the MagicNumber/String  'Committed offset for partition:[{}] is : [{}], but the target offset: [{}] ' should be converted to const"
}} 
,
{ "ligne" : {"" : ""
 , "c1" : "00120"
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00120] In method org.apache.kafka.server.log.remote.metadata.storage.ConsumerManager.waitTillConsumptionCatchesUp@POLYN174478 the MagicNumber/String  'Timed out in catching up with the expected offset by consumer.' should be converted to const"
}} 
,
{ "ligne" : {"" : ""
 , "c1" : "00130"
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00130] In method org.apache.kafka.server.log.remote.metadata.storage.ConsumerManager.close@POLYN176023 the MagicNumber/String  'ConsumerTask' should be converted to const"
}} 
,
{ "ligne" : {"" : ""
 , "c1" : "00136"
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00136] In method org.apache.kafka.server.log.remote.metadata.storage.ConsumerManager.close@POLYN176023 the MagicNumber/String  'Encountered error while waiting for consumerTaskThread to finish.' should be converted to const"
}} 
,
{ "ligne" : {"" : ""
 , "c1" : "00140"
