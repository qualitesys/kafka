...
"data00" : {
 ...
 , "texte" : "File streams/src/main/java/org/apache/kafka/streams/processor/FailOnInvalidTimestamp.java 6 rule violations " 
...
{ "ligne" : {"" : ""
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00065] In method org.apache.kafka.streams.processor.FailOnInvalidTimestamp.onInvalidTimestamp@POLYN153054 the MagicNumber/String  'Input record ' should be converted to const"
}} 
,
{ "ligne" : {"" : ""
 , "c1" : "00065"
 , "c1link" : "./qc/streams/src/main/java/org/apache/kafka/streams/processor/FailOnInvalidTimestamp.java.html#65"
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00065] In method org.apache.kafka.streams.processor.FailOnInvalidTimestamp.onInvalidTimestamp@POLYN153054 the MagicNumber/String  ' has invalid (negative) timestamp. ' should be converted to const"
}} 
,
{ "ligne" : {"" : ""
 , "c1" : "00066"
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00066] In method org.apache.kafka.streams.processor.FailOnInvalidTimestamp.onInvalidTimestamp@POLYN153054 the MagicNumber/String  'Possibly because a pre-0.10 producer client was used to write this record to Kafka without embedding ' should be converted to const"
}} 
,
{ "ligne" : {"" : ""
 , "c1" : "00067"
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00067] In method org.apache.kafka.streams.processor.FailOnInvalidTimestamp.onInvalidTimestamp@POLYN153054 the MagicNumber/String  'a timestamp, or because the input topic was created before upgrading the Kafka cluster to 0.10+. ' should be converted to const"
}} 
,
{ "ligne" : {"" : ""
 , "c1" : "00068"
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00068] In method org.apache.kafka.streams.processor.FailOnInvalidTimestamp.onInvalidTimestamp@POLYN153054 the MagicNumber/String  'Use a different TimestampExtractor to process this data.' should be converted to const"
}} 
]
, 
"data15" : {
