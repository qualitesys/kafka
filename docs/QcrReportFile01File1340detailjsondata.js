...
"data00" : {
 ...
 , "texte" : "File metadata/src/main/java/org/apache/kafka/image/LocalReplicaChanges.java 2 rule violations " 
 , "fic3"  : "" 
}
, 
"data01" : [
...
{ "ligne" : {"" : ""
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00057] In method org.apache.kafka.image.LocalReplicaChanges.toString@POLYN156599 the MagicNumber/String  'LocalReplicaChanges(deletes = %s, leaders = %s, followers = %s)' should be converted to const"
}} 
,
{ "ligne" : {"" : ""
 , "c1" : "00075"
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00075] In method org.apache.kafka.image.LocalReplicaChanges.PartitionInfo.toString@POLYN157151 the MagicNumber/String  'PartitionInfo(topicId = %s, partition = %s)' should be converted to const"
}} 
]
, 
"data15" : {
