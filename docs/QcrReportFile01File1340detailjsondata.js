...
{ "ligne" : {"" : ""
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00057] In method org.apache.kafka.image.LocalReplicaChanges.toString@POLYN148247 the MagicNumber/String  'LocalReplicaChanges(deletes = %s, leaders = %s, followers = %s)' should be converted to const"
}} 
,
{ "ligne" : {"" : ""
 , "c1" : "00075"
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00075] In method org.apache.kafka.image.LocalReplicaChanges.PartitionInfo.toString@POLYN148799 the MagicNumber/String  'PartitionInfo(topicId = %s, partition = %s)' should be converted to const"
}} 
]
, 
"data15" : {
