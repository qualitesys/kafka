...
{ "ligne" : {
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00061] In method org.apache.kafka.raft.LeaderState.LeaderState@POLYN207807 the MagicNumber/String  'accumulator must be non-null' should be converted to const"
}} 
,
{ "ligne" : {
   "c1" : "00068"
...
{ "ligne" : {
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00093] In method org.apache.kafka.raft.LeaderState.requestResign@POLYN210293 the MagicNumber/String  true should be converted to const"
}} 
,
{ "ligne" : {
   "c1" : "00132"
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00132] In method org.apache.kafka.raft.LeaderState.updateHighWatermark@POLYN211474 the MagicNumber/String  2 should be converted to const"
}} 
,
{ "ligne" : {
   "c1" : "00155"
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00155] In method org.apache.kafka.raft.LeaderState.updateHighWatermark@POLYN211474 the MagicNumber/String  'High watermark updated to {} based on indexOfHw {} and voters {}' should be converted to const"
}} 
,
{ "ligne" : {
   "c1" : "00160"
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00160] In method org.apache.kafka.raft.LeaderState.updateHighWatermark@POLYN211474 the MagicNumber/String  true should be converted to const"
}} 
,
{ "ligne" : {
   "c1" : "00162"
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00162] In method org.apache.kafka.raft.LeaderState.updateHighWatermark@POLYN211474 the MagicNumber/String  'The latest computed high watermark {} is smaller than the current ' should be converted to const"
}} 
,
{ "ligne" : {
   "c1" : "00163"
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00163] In method org.apache.kafka.raft.LeaderState.updateHighWatermark@POLYN211474 the MagicNumber/String  'value {}, which suggests that one of the voters has lost committed data. ' should be converted to const"
}} 
,
{ "ligne" : {
   "c1" : "00164"
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00164] In method org.apache.kafka.raft.LeaderState.updateHighWatermark@POLYN211474 the MagicNumber/String  'Full voter replication state: {}' should be converted to const"
}} 
,
{ "ligne" : {
   "c1" : "00166"
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00166] In method org.apache.kafka.raft.LeaderState.updateHighWatermark@POLYN211474 the MagicNumber/String  false should be converted to const"
}} 
,
{ "ligne" : {
   "c1" : "00168"
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00168] In method org.apache.kafka.raft.LeaderState.updateHighWatermark@POLYN211474 the MagicNumber/String  false should be converted to const"
}} 
,
{ "ligne" : {
   "c1" : "00173"
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00173] In method org.apache.kafka.raft.LeaderState.updateHighWatermark@POLYN211474 the MagicNumber/String  'High watermark set to {} based on indexOfHw {} and voters {}' should be converted to const"
}} 
,
{ "ligne" : {
   "c1" : "00178"
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00178] In method org.apache.kafka.raft.LeaderState.updateHighWatermark@POLYN211474 the MagicNumber/String  true should be converted to const"
}} 
,
{ "ligne" : {
   "c1" : "00182"
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00182] In method org.apache.kafka.raft.LeaderState.updateHighWatermark@POLYN211474 the MagicNumber/String  false should be converted to const"
}} 
,
{ "ligne" : {
   "c1" : "00186"
...
{ "ligne" : {
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00196] In method org.apache.kafka.raft.LeaderState.updateReplicaState@POLYN213880 the MagicNumber/String  0 should be converted to const"
}} 
,
{ "ligne" : {
   "c1" : "00197"
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00197] In method org.apache.kafka.raft.LeaderState.updateReplicaState@POLYN213880 the MagicNumber/String  false should be converted to const"
}} 
,
{ "ligne" : {
   "c1" : "00218"
...
{ "ligne" : {
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00223] In method org.apache.kafka.raft.LeaderState.updateEndOffset@POLYN215009 the MagicNumber/String  'Detected non-monotonic update of local ' should be converted to const"
}} 
,
{ "ligne" : {
   "c1" : "00224"
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00224] In method org.apache.kafka.raft.LeaderState.updateEndOffset@POLYN215009 the MagicNumber/String  'end offset: ' should be converted to const"
}} 
,
{ "ligne" : {
   "c1" : "00224"
 , "c1link" : "./qc/raft/src/main/java/org/apache/kafka/raft/LeaderState.java.html#224"
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00224] In method org.apache.kafka.raft.LeaderState.updateEndOffset@POLYN215009 the MagicNumber/String  ' -&amp;gt; ' should be converted to const"
}} 
,
{ "ligne" : {
   "c1" : "00226"
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00226] In method org.apache.kafka.raft.LeaderState.updateEndOffset@POLYN215009 the MagicNumber/String  'Detected non-monotonic update of fetch offset from nodeId {}: {} -&amp;gt; {}' should be converted to const"
}} 
,
{ "ligne" : {
   "c1" : "00233"
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00233] In method org.apache.kafka.raft.LeaderState.updateEndOffset@POLYN215009 the MagicNumber/String  true should be converted to const"
}} 
,
{ "ligne" : {
   "c1" : "00237"
...
{ "ligne" : {
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00239] In method org.apache.kafka.raft.LeaderState.addAcknowledgementFrom@POLYN216003 the MagicNumber/String  true should be converted to const"
}} 
,
{ "ligne" : {
   "c1" : "00242"
...
{ "ligne" : {
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00244] In method org.apache.kafka.raft.LeaderState.ensureValidVoter@POLYN216224 the MagicNumber/String  null should be converted to const"
}} 
,
{ "ligne" : {
   "c1" : "00245"
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00245] In method org.apache.kafka.raft.LeaderState.ensureValidVoter@POLYN216224 the MagicNumber/String  'Unexpected acknowledgement from non-voter ' should be converted to const"
}} 
,
{ "ligne" : {
   "c1" : "00253"
...
{ "ligne" : {
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00255] In method org.apache.kafka.raft.LeaderState.getReplicaState@POLYN216665 the MagicNumber/String  null should be converted to const"
}} 
,
{ "ligne" : {
   "c1" : "00256"
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00256] In method org.apache.kafka.raft.LeaderState.getReplicaState@POLYN216665 the MagicNumber/String  false should be converted to const"
}} 
,
{ "ligne" : {
   "c1" : "00266"
...
{ "ligne" : {
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00283] In method org.apache.kafka.raft.LeaderState.clearInactiveObservers@POLYN218105 the MagicNumber/String  1 should be converted to const"
}} 
,
{ "ligne" : {
   "c1" : "00287"
...
{ "ligne" : {
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00307] In method org.apache.kafka.raft.LeaderState.ReplicaState.updateFetchTimestamp@POLYN219175 the MagicNumber/String  1L should be converted to const"
}} 
,
{ "ligne" : {
   "c1" : "00311"
...
{ "ligne" : {
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00315] In method org.apache.kafka.raft.LeaderState.ReplicaState.compareTo@POLYN219464 the MagicNumber/String  1 should be converted to const"
}} 
,
{ "ligne" : {
   "c1" : "00317"
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00317] In method org.apache.kafka.raft.LeaderState.ReplicaState.compareTo@POLYN219464 the MagicNumber/String  1 should be converted to const"
}} 
,
{ "ligne" : {
   "c1" : "00325"
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00325] In method org.apache.kafka.raft.LeaderState.ReplicaState.toString@POLYN220150 the MagicNumber/String  'ReplicaState(nodeId=%d, endOffset=%s, lastFetchTimestamp=%s, hasAcknowledgedLeader=%s)' should be converted to const"
}} 
,
{ "ligne" : {
   "c1" : "00335"
...
{ "ligne" : {
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00336] In method org.apache.kafka.raft.LeaderState.canGrantVote@POLYN220382 the MagicNumber/String  'Rejecting vote request from candidate {} since we are already leader in epoch {}' should be converted to const"
}} 
,
{ "ligne" : {
   "c1" : "00338"
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00338] In method org.apache.kafka.raft.LeaderState.canGrantVote@POLYN220382 the MagicNumber/String  false should be converted to const"
}} 
,
{ "ligne" : {
   "c1" : "00344"
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00344] In method org.apache.kafka.raft.LeaderState.toString@POLYN220648 the MagicNumber/String  'Leader(localId=%d, epoch=%d, epochStartOffset=%d, highWatermark=%s, voterStates=%s)' should be converted to const"
}} 
,
{ "ligne" : {
   "c1" : "00355"
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00355] In method org.apache.kafka.raft.LeaderState.name@POLYN220899 the MagicNumber/String  'Leader' should be converted to const"
}} 
]
};
