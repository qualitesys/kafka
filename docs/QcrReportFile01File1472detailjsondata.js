...
{ "ligne" : {
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00025] In method org.apache.kafka.shell.HistoryCommandHandler.HistoryCommandType.name@POLYN169396 the MagicNumber/String  'history' should be converted to const"
}} 
,
{ "ligne" : {
   "c1" : "00030"
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00030] In method org.apache.kafka.shell.HistoryCommandHandler.HistoryCommandType.description@POLYN169498 the MagicNumber/String  'Print command history.' should be converted to const"
}} 
,
{ "ligne" : {
   "c1" : "00035"
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00035] In method org.apache.kafka.shell.HistoryCommandHandler.HistoryCommandType.shellOnly@POLYN169600 the MagicNumber/String  true should be converted to const"
}} 
,
{ "ligne" : {
   "c1" : "00039"
...
{ "ligne" : {
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00040] In method org.apache.kafka.shell.HistoryCommandHandler.HistoryCommandType.addArguments@POLYN169694 the MagicNumber/String  'numEntriesToShow' should be converted to const"
}} 
,
{ "ligne" : {
   "c1" : "00041"
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00041] In method org.apache.kafka.shell.HistoryCommandHandler.HistoryCommandType.addArguments@POLYN169694 the MagicNumber/String  '?' should be converted to const"
}} 
,
{ "ligne" : {
   "c1" : "00043"
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00043] In method org.apache.kafka.shell.HistoryCommandHandler.HistoryCommandType.addArguments@POLYN169694 the MagicNumber/String  'The number of entries to show.' should be converted to const"
}} 
,
{ "ligne" : {
   "c1" : "00047"
...
{ "ligne" : {
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00048] In method org.apache.kafka.shell.HistoryCommandHandler.HistoryCommandType.createHandler@POLYN169991 the MagicNumber/String  'numEntriesToShow' should be converted to const"
}} 
,
{ "ligne" : {
   "c1" : "00049"
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00049] In method org.apache.kafka.shell.HistoryCommandHandler.HistoryCommandType.createHandler@POLYN169991 the MagicNumber/String  null should be converted to const"
}} 
,
{ "ligne" : {
   "c1" : "00054"
...
{ "ligne" : {
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00071] In method org.apache.kafka.shell.HistoryCommandHandler.run@POLYN170668 the MagicNumber/String  'The history command requires a shell.' should be converted to const"
}} 
,
{ "ligne" : {
   "c1" : "00076"
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00076] In method org.apache.kafka.shell.HistoryCommandHandler.run@POLYN170668 the MagicNumber/String  '% 5d  %s%n' should be converted to const"
}} 
,
{ "ligne" : {
   "c1" : "00086"
...
{ "ligne" : {
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00087] In method org.apache.kafka.shell.HistoryCommandHandler.equals@POLYN171619 the MagicNumber/String  false should be converted to const"
}} 
,
{ "ligne" : {
   "c1" : "00001"
 ...
 , "c2" : "CRITICAL"
 , "c3" : "QC-JAV999994[00001] Recursive call with depth 1 for org.apache.kafka.shell.HistoryCommandHandler.run@POLYN170668"
}} 
,
{ "ligne" : {
   "c1" : "00071"
 , "c1link" : "./qc/shell/src/main/java/org/apache/kafka/shell/HistoryCommandHandler.java.html#71"
 , "c2" : "BLOCKER"
 , "c3" : "QC-JAV999993[00071] In the recursive method org.apache.kafka.shell.HistoryCommandHandler.run@POLYN170668 the MagicNumber/String 'The history command requires a shell.' MUST BE CONVERTED to const"
}} 
,
{ "ligne" : {
   "c1" : "00076"
 , "c1link" : "./qc/shell/src/main/java/org/apache/kafka/shell/HistoryCommandHandler.java.html#76"
 , "c2" : "BLOCKER"
 , "c3" : "QC-JAV999993[00076] In the recursive method org.apache.kafka.shell.HistoryCommandHandler.run@POLYN170668 the MagicNumber/String '% 5d  %s%n' MUST BE CONVERTED to const"
}} 
]
};
