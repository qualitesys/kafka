...
{ "ligne" : {
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00016] In method org.apache.kafka.streams.processor.UsePartitionTimeOnInvalidTimestamp.onInvalidTimestamp@POLYN171355 the MagicNumber/String  0 should be converted to const"
}} 
,
{ "ligne" : {
   "c1" : "00017"
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00017] In method org.apache.kafka.streams.processor.UsePartitionTimeOnInvalidTimestamp.onInvalidTimestamp@POLYN171355 the MagicNumber/String  'Could not infer new timestamp for input record ' should be converted to const"
}} 
,
{ "ligne" : {
   "c1" : "00018"
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00018] In method org.apache.kafka.streams.processor.UsePartitionTimeOnInvalidTimestamp.onInvalidTimestamp@POLYN171355 the MagicNumber/String  ' because partition time is unknown.' should be converted to const"
}} 
]
};
