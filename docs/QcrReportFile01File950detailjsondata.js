...
{ "ligne" : {
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00014] In method org.apache.kafka.connect.data.Timestamp.builder@POLYN168602 the MagicNumber/String  1 should be converted to const"
}} 
,
{ "ligne" : {
   "c1" : "00020"
...
{ "ligne" : {
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00022] In method org.apache.kafka.connect.data.Timestamp.fromLogical@POLYN169014 the MagicNumber/String  'Requested conversion of Timestamp object but the schema does not match.' should be converted to const"
}} 
,
{ "ligne" : {
   "c1" : "00026"
...
{ "ligne" : {
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00028] In method org.apache.kafka.connect.data.Timestamp.toLogical@POLYN169401 the MagicNumber/String  'Requested conversion of Timestamp object but the schema does not match.' should be converted to const"
}} 
]
};
