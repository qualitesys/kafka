...
"data00" : {
 ...
 , "texte" : "File streams/src/main/java/org/apache/kafka/streams/state/internals/CompositeReadOnlyWindowStore.java 25 rule violations " 
...
{ "ligne" : {
   "c1" : "00016"
 , "c1link" : "./qc/streams/src/main/java/org/apache/kafka/streams/state/internals/CompositeReadOnlyWindowStore.java.html#16"
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000008[00016] The class CompositeReadOnlyWindowStore contains no field, constructor, finalize. Must contain only static methods, check it"
}} 
,
{ "ligne" : {
   "c1" : "00031"
...
{ "ligne" : {
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00032] In method org.apache.kafka.streams.state.internals.CompositeReadOnlyWindowStore.fetch@POLYN184485 the MagicNumber/String  'key can't be null' should be converted to const"
}} 
,
{ "ligne" : {
   "c1" : "00037"
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00037] In method org.apache.kafka.streams.state.internals.CompositeReadOnlyWindowStore.fetch@POLYN184485 the MagicNumber/String  null should be converted to const"
}} 
,
{ "ligne" : {
   "c1" : "00042"
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00042] In method org.apache.kafka.streams.state.internals.CompositeReadOnlyWindowStore.fetch@POLYN184485 the MagicNumber/String  'State store is not available anymore and may have been migrated to another instance; ' should be converted to const"
}} 
,
{ "ligne" : {
   "c1" : "00043"
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00043] In method org.apache.kafka.streams.state.internals.CompositeReadOnlyWindowStore.fetch@POLYN184485 the MagicNumber/String  'please re-discover its location from the state metadata.' should be converted to const"
}} 
,
{ "ligne" : {
   "c1" : "00046"
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00046] In method org.apache.kafka.streams.state.internals.CompositeReadOnlyWindowStore.fetch@POLYN184485 the MagicNumber/String  null should be converted to const"
}} 
,
{ "ligne" : {
   "c1" : "00050"
...
{ "ligne" : {
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00053] In method org.apache.kafka.streams.state.internals.CompositeReadOnlyWindowStore.fetch@POLYN185450 the MagicNumber/String  'key can't be null' should be converted to const"
}} 
,
{ "ligne" : {
   "c1" : "00065"
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00065] In method org.apache.kafka.streams.state.internals.CompositeReadOnlyWindowStore.fetch@POLYN185450 the MagicNumber/String  'State store is not available anymore and may have been migrated to another instance; ' should be converted to const"
}} 
,
{ "ligne" : {
   "c1" : "00066"
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00066] In method org.apache.kafka.streams.state.internals.CompositeReadOnlyWindowStore.fetch@POLYN185450 the MagicNumber/String  'please re-discover its location from the state metadata.' should be converted to const"
}} 
,
{ "ligne" : {
   "c1" : "00073"
...
{ "ligne" : {
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00076] In method org.apache.kafka.streams.state.internals.CompositeReadOnlyWindowStore.backwardFetch@POLYN186580 the MagicNumber/String  'key can't be null' should be converted to const"
}} 
,
{ "ligne" : {
   "c1" : "00088"
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00088] In method org.apache.kafka.streams.state.internals.CompositeReadOnlyWindowStore.backwardFetch@POLYN186580 the MagicNumber/String  'State store is not available anymore and may have been migrated to another instance; ' should be converted to const"
}} 
,
{ "ligne" : {
   "c1" : "00089"
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00089] In method org.apache.kafka.streams.state.internals.CompositeReadOnlyWindowStore.backwardFetch@POLYN186580 the MagicNumber/String  'please re-discover its location from the state metadata.' should be converted to const"
}} 
,
{ "ligne" : {
   "c1" : "00096"
