...
{ "ligne" : {"" : ""
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00042] In method org.apache.kafka.clients.consumer.internals.OffsetsForLeaderEpochClient.prepareRequest@POLYN162034 the MagicNumber/String  null should be converted to const"
}} 
,
{ "ligne" : {"" : ""
 , "c1" : "00058"
...
{ "ligne" : {"" : ""
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00072] In method org.apache.kafka.clients.consumer.internals.OffsetsForLeaderEpochClient.handleResponse@POLYN163266 the MagicNumber/String  'Received unrequested topic or partition {} from response, ignoring.' should be converted to const"
}} 
,
{ "ligne" : {"" : ""
 , "c1" : "00079"
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00079] In method org.apache.kafka.clients.consumer.internals.OffsetsForLeaderEpochClient.handleResponse@POLYN163266 the MagicNumber/String  'Handling OffsetsForLeaderEpoch response for {}. Got offset {} for epoch {}.' should be converted to const"
}} 
,
{ "ligne" : {"" : ""
 , "c1" : "00091"
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00091] In method org.apache.kafka.clients.consumer.internals.OffsetsForLeaderEpochClient.handleResponse@POLYN163266 the MagicNumber/String  'Attempt to fetch offsets for partition {} failed due to {}, retrying.' should be converted to const"
}} 
,
{ "ligne" : {"" : ""
 , "c1" : "00095"
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00095] In method org.apache.kafka.clients.consumer.internals.OffsetsForLeaderEpochClient.handleResponse@POLYN163266 the MagicNumber/String  'Received unknown topic or partition error in OffsetsForLeaderEpoch request for partition {}.' should be converted to const"
}} 
,
{ "ligne" : {"" : ""
 , "c1" : "00103"
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00103] In method org.apache.kafka.clients.consumer.internals.OffsetsForLeaderEpochClient.handleResponse@POLYN163266 the MagicNumber/String  'Attempt to fetch offsets for partition {} failed due to: {}, retrying.' should be converted to const"
}} 
,
{ "ligne" : {"" : ""
 , "c1" : "00115"
...
"data15" : [
   "fichierplantumlsvg" : "./qc/clients/src/main/java/org/apache/kafka/clients/consumer/internals/OffsetsForLeaderEpochClient.java.svg" }
