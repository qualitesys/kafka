...
{ "ligne" : {"" : ""
 ...
 , "c2" : "MINOR"
 , "c3" : "QC-JAV000007[00054] For method get list of called methods Object monObjet|org.apache.kafka.common.metrics.Sensor TaskMetrics_droppedRecordsSensorN170850|org.apache.kafka.streams.processor.api.ProcessorContext contextN171589|org.apache.kafka.common.utils.Bytes keySchema_toBytesN172283|V store_getN172709"
}} 
,
{ "ligne" : {"" : ""
 , "c1" : "00078"
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00078] In method org.apache.kafka.streams.kstream.internals.foreignkeyjoin.SubscriptionStoreReceiveProcessorSupplier.get@POLYN169994 the MagicNumber/String  null should be converted to const"
}} 
,
{ "ligne" : {"" : ""
 , "c1" : "00082"
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00082] In method org.apache.kafka.streams.kstream.internals.foreignkeyjoin.SubscriptionStoreReceiveProcessorSupplier.get@POLYN169994 the MagicNumber/String  'Skipping record due to null foreign key. ' should be converted to const"
}} 
,
{ "ligne" : {"" : ""
 , "c1" : "00083"
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00083] In method org.apache.kafka.streams.kstream.internals.foreignkeyjoin.SubscriptionStoreReceiveProcessorSupplier.get@POLYN169994 the MagicNumber/String  'topic=[{}] partition=[{}] offset=[{}]' should be converted to const"
}} 
,
{ "ligne" : {"" : ""
 , "c1" : "00088"
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00088] In method org.apache.kafka.streams.kstream.internals.foreignkeyjoin.SubscriptionStoreReceiveProcessorSupplier.get@POLYN169994 the MagicNumber/String  'Skipping record due to null foreign key. Topic, partition, and offset not known.' should be converted to const"
}} 
,
{ "ligne" : {"" : ""
 , "c1" : "00098"
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00098] In method org.apache.kafka.streams.kstream.internals.foreignkeyjoin.SubscriptionStoreReceiveProcessorSupplier.get@POLYN169994 the MagicNumber/String  'SubscriptionWrapper is of an incompatible version.' should be converted to const"
}} 
]
, 
"data15" : {
