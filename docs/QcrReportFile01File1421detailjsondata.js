...
"data00" : {
 ...
 , "texte" : "File raft/src/main/java/org/apache/kafka/raft/VotedState.java 22 rule violations " 
...
{ "ligne" : {
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00062] In method org.apache.kafka.raft.VotedState.name@POLYN174130 the MagicNumber/String  'Voted' should be converted to const"
}} 
,
{ "ligne" : {
   "c1" : "00065"
...
{ "ligne" : {
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00083] In method org.apache.kafka.raft.VotedState.canGrantVote@POLYN174860 the MagicNumber/String  true should be converted to const"
}} 
,
{ "ligne" : {
   "c1" : "00086"
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00086] In method org.apache.kafka.raft.VotedState.canGrantVote@POLYN174860 the MagicNumber/String  'Rejecting vote request from candidate {} since we already have voted for ' should be converted to const"
}} 
,
{ "ligne" : {
   "c1" : "00087"
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00087] In method org.apache.kafka.raft.VotedState.canGrantVote@POLYN174860 the MagicNumber/String  'another candidate {} in epoch {}' should be converted to const"
}} 
,
{ "ligne" : {
   "c1" : "00088"
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00088] In method org.apache.kafka.raft.VotedState.canGrantVote@POLYN174860 the MagicNumber/String  false should be converted to const"
}} 
,
{ "ligne" : {
   "c1" : "00098"
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00098] In method org.apache.kafka.raft.VotedState.toString@POLYN175426 the MagicNumber/String  'Voted(' should be converted to const"
}} 
,
{ "ligne" : {
   "c1" : "00099"
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00099] In method org.apache.kafka.raft.VotedState.toString@POLYN175426 the MagicNumber/String  'epoch=' should be converted to const"
}} 
,
{ "ligne" : {
   "c1" : "00100"
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00100] In method org.apache.kafka.raft.VotedState.toString@POLYN175426 the MagicNumber/String  ', votedId=' should be converted to const"
}} 
,
{ "ligne" : {
   "c1" : "00101"
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00101] In method org.apache.kafka.raft.VotedState.toString@POLYN175426 the MagicNumber/String  ', voters=' should be converted to const"
}} 
,
{ "ligne" : {
   "c1" : "00102"
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00102] In method org.apache.kafka.raft.VotedState.toString@POLYN175426 the MagicNumber/String  ', electionTimeoutMs=' should be converted to const"
}} 
,
{ "ligne" : {
   "c1" : "00103"
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00103] In method org.apache.kafka.raft.VotedState.toString@POLYN175426 the MagicNumber/String  ')' should be converted to const"
}} 
,
{ "ligne" : {
   "c1" : "00107"
...
{ "ligne" : {
 ...
 , "c2" : "CRITICAL"
 , "c3" : "QC-JAV999994[00001] Recursive call with depth 1 for org.apache.kafka.raft.VotedState.VotedState@POLYN172868"
}} 
,
{ "ligne" : {
   "c1" : "00001"
 , "c1link" : "./qc/raft/src/main/java/org/apache/kafka/raft/VotedState.java.html#1"
 , "c2" : "CRITICAL"
 , "c3" : "QC-JAV999994[00001] Recursive call with depth 1 for org.apache.kafka.raft.VotedState.election@POLYN173681"
}} 
]
};
