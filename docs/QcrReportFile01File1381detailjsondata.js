...
{ "ligne" : {
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00042] In method org.apache.kafka.timeline.SnapshotRegistry.SnapshotIterator.remove@POLYN194999 the MagicNumber/String  null should be converted to const"
}} 
,
{ "ligne" : {
   "c1" : "00046"
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00046] In method org.apache.kafka.timeline.SnapshotRegistry.SnapshotIterator.remove@POLYN194999 the MagicNumber/String  null should be converted to const"
}} 
,
{ "ligne" : {
   "c1" : "00051"
...
{ "ligne" : {
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00122] In method org.apache.kafka.timeline.SnapshotRegistry.getSnapshot@POLYN198441 the MagicNumber/String  null should be converted to const"
}} 
,
{ "ligne" : {
   "c1" : "00123"
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00123] In method org.apache.kafka.timeline.SnapshotRegistry.getSnapshot@POLYN198441 the MagicNumber/String  'No snapshot for epoch ' should be converted to const"
}} 
,
{ "ligne" : {
   "c1" : "00123"
 , "c1link" : "./qc/metadata/src/main/java/org/apache/kafka/timeline/SnapshotRegistry.java.html#123"
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00123] In method org.apache.kafka.timeline.SnapshotRegistry.getSnapshot@POLYN198441 the MagicNumber/String  '. Snapshot ' should be converted to const"
}} 
,
{ "ligne" : {
   "c1" : "00124"
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00124] In method org.apache.kafka.timeline.SnapshotRegistry.getSnapshot@POLYN198441 the MagicNumber/String  'epochs are: ' should be converted to const"
}} 
,
{ "ligne" : {
   "c1" : "00125"
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00125] In method org.apache.kafka.timeline.SnapshotRegistry.getSnapshot@POLYN198441 the MagicNumber/String  ', ' should be converted to const"
}} 
,
{ "ligne" : {
   "c1" : "00131"
...
{ "ligne" : {
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00134] In method org.apache.kafka.timeline.SnapshotRegistry.getOrCreateSnapshot@POLYN199287 the MagicNumber/String  'Can't create a new snapshot at epoch ' should be converted to const"
}} 
,
{ "ligne" : {
   "c1" : "00135"
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00135] In method org.apache.kafka.timeline.SnapshotRegistry.getOrCreateSnapshot@POLYN199287 the MagicNumber/String  ' because there is already a snapshot with epoch ' should be converted to const"
}} 
,
{ "ligne" : {
   "c1" : "00142"
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00142] In method org.apache.kafka.timeline.SnapshotRegistry.getOrCreateSnapshot@POLYN199287 the MagicNumber/String  'Creating snapshot {}' should be converted to const"
}} 
,
{ "ligne" : {
   "c1" : "00147"
...
{ "ligne" : {
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00153] In method org.apache.kafka.timeline.SnapshotRegistry.revertToSnapshot@POLYN200306 the MagicNumber/String  'Deleting snapshot {} because we are reverting to {}' should be converted to const"
}} 
,
{ "ligne" : {
   "c1" : "00161"
...
{ "ligne" : {
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00173] In method org.apache.kafka.timeline.SnapshotRegistry.deleteSnapshot@POLYN201319 the MagicNumber/String  'Deleting snapshot {}' should be converted to const"
}} 
,
{ "ligne" : {
   "c1" : "00178"
...
{ "ligne" : {
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00184] In method org.apache.kafka.timeline.SnapshotRegistry.deleteSnapshotsUpTo@POLYN201990 the MagicNumber/String  'Deleting snapshot {}' should be converted to const"
}} 
,
{ "ligne" : {
   "c1" : "00195"
