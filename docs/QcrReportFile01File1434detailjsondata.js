...
{ "ligne" : {
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00064] In method org.apache.kafka.raft.internals.RecordsIterator.next@POLYN191803 the MagicNumber/String  'Batch iterator doesn't have any more elements' should be converted to const"
}} 
,
{ "ligne" : {
   "c1" : "00075"
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00075] In method org.apache.kafka.raft.internals.RecordsIterator.close@POLYN192211 the MagicNumber/String  true should be converted to const"
}} 
,
{ "ligne" : {
   "c1" : "00082"
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00082] In method org.apache.kafka.raft.internals.RecordsIterator.ensureOpen@POLYN192465 the MagicNumber/String  'Serde record batch itererator was closed' should be converted to const"
}} 
,
{ "ligne" : {
   "c1" : "00086"
...
{ "ligne" : {
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00091] In method org.apache.kafka.raft.internals.RecordsIterator.readFileRecords@POLYN192639 the MagicNumber/String  'Failed to read records into memory' should be converted to const"
}} 
,
{ "ligne" : {
   "c1" : "00098"
...
{ "ligne" : {
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00135] In method org.apache.kafka.raft.internals.RecordsIterator.nextBatches@POLYN194581 the MagicNumber/String  'Unexpected Records type %s' should be converted to const"
}} 
,
{ "ligne" : {
   "c1" : "00157"
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00157] In method org.apache.kafka.raft.internals.RecordsIterator.nextBatch@POLYN195502 the MagicNumber/String  'DefaultRecordBatch expected by record type was %s' should be converted to const"
}} 
,
{ "ligne" : {
   "c1" : "00167"
...
{ "ligne" : {
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00179] In method org.apache.kafka.raft.internals.RecordsIterator.readBatch@POLYN196496 the MagicNumber/String  null should be converted to const"
}} 
,
{ "ligne" : {
   "c1" : "00180"
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00180] In method org.apache.kafka.raft.internals.RecordsIterator.readBatch@POLYN196496 the MagicNumber/String  'Expected a record count for the records batch' should be converted to const"
}} 
,
{ "ligne" : {
   "c1" : "00185"
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00185] In method org.apache.kafka.raft.internals.RecordsIterator.readBatch@POLYN196496 the MagicNumber/String  0 should be converted to const"
}} 
,
{ "ligne" : {
   "c1" : "00203"
...
{ "ligne" : {
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00211] In method org.apache.kafka.raft.internals.RecordsIterator.readRecord@POLYN198115 the MagicNumber/String  0 should be converted to const"
}} 
,
{ "ligne" : {
   "c1" : "00219"
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00219] In method org.apache.kafka.raft.internals.RecordsIterator.readRecord@POLYN198115 the MagicNumber/String  1 should be converted to const"
}} 
,
{ "ligne" : {
   "c1" : "00220"
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00220] In method org.apache.kafka.raft.internals.RecordsIterator.readRecord@POLYN198115 the MagicNumber/String  'Unexpected key size ' should be converted to const"
}} 
,
{ "ligne" : {
   "c1" : "00224"
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00224] In method org.apache.kafka.raft.internals.RecordsIterator.readRecord@POLYN198115 the MagicNumber/String  0 should be converted to const"
}} 
,
{ "ligne" : {
   "c1" : "00232"
 ...
 , "c2" : "MAJOR"
 , "c3" : "QC-JAV000010[00232] In method org.apache.kafka.raft.internals.RecordsIterator.readRecord@POLYN198115 the MagicNumber/String  0 should be converted to const"
}} 
]
};
